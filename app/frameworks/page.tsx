...
import { InferenceLog } from "@/components/frameworks/InferenceLog";
        ...
        <div className="max-w-7xl mx-auto space-y-12 pb-12">
            ...
            <section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                    <div className="col-span-1 lg:col-span-2 space-y-6">
                        <p className="text-sidebar-foreground max-w-4xl">
                        ...
                        {/* AI Context Card */}
                        <div className="bg-accent/5 border border-accent/20 rounded-xl p-4 flex gap-4">
                    ...
                    <div className="col-span-1">
                        <InferenceLog system="AEGIS" color="text-accent" />
                    </div>
                </div>
            ...
            <section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                    <div className="col-span-1 lg:col-span-2 space-y-6">
                        ...
                        {/* AI Context Card */}
                        <div className="bg-purple-500/5 border border-purple-500/20 rounded-xl p-4 flex gap-4">
                    ...
                    <div className="col-span-1">
                        <InferenceLog system="NEXUS" color="text-purple-400" />
                    </div>
                </div>
            ...
            <section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                    <div className="col-span-1 lg:col-span-2 space-y-6">
                        ...
                        {/* AI Context Card */}
                        <div className="bg-pink-500/5 border border-pink-500/20 rounded-xl p-4 flex gap-4">
                    ...
                    <div className="col-span-1">
                        <InferenceLog system="SONAR" color="text-pink-400" />
                    </div>
                </div>
            ...
            <section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div className="col-span-1">
                        <InferenceLog system="HAWK" color="text-orange-400" />
                    </div>
                </div>
